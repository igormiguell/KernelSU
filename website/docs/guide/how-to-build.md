...
Starting with Android 13, the kernel is built by `bazel`:
...
:::info
For some Android 14 kernels, to make Wi-Fi/Bluetooth work, it may be necessary to remove all GKI protected exports:
